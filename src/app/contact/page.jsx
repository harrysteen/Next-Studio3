  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.ok && data.success) {
        ...
        setStatus("error");
        setErrorMessage(data.error || "Failed to send message. Please check credentials.");
      }
    } catch (err) {
      setStatus("error");
        ...
        <div className={styles.contentContainer}>
          ...
          <div className={styles.leftColumn}>
            <h1 className={styles.headline}>
              <span className={styles.highlight}>LET&apos;S START</span> WITH QUESTIONS.
              <br />
                    ...
                    <div className={styles.checkboxes}>
                      ...
                      <label className={styles.checkboxItem}>
                        <input
                          type="checkbox"
                          name="webDev"
                          checked={formData.services.webDev}
                          onChange={handleChange}
                        />{" "}
                        Website Development
                      </label>
                      <label className={styles.checkboxItem}>
                        <input
                          ...
                          checked={formData.services.contentStrategy}
                          onChange={handleChange}
                        />{" "}
                        Content Strategy
                      </label>
