...
export default function Ecomall() {
  ...
  return (
    <div style={containerStyle}>
        ...
        <section style={{ marginBottom: "100px" }}>
          ...
          <div style={{
            ...
            <p style={{
              ...
              Ecomall delivered a comprehensive digital e-commerce platform equipped with intuitive customer workflows and modern user interfaces.
            </p>
          </div>
        </section>
      </main>
      ...
      <LatestWork currentProjectId="ecomall" />
